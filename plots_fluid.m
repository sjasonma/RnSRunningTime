hold on
plot(n_KN_true(:,[1,4,5]), n_KN_reg_fluid(:,[1,4,5]), '*')
plot(n_KN_true(:,[1,4,5]), n_KN_naive_fluid(:,[1,4,5]), 'o')
...
hold on
plot(n_KN_true(:,[2,6,7]), n_KN_reg_fluid(:,[2,6,7]), '*')
plot(n_KN_true(:,[2,6,7]), n_KN_naive_fluid(:,[2,6,7]), 'o')
...
hold on
plot(n_KN_true(:,[3, 8]), n_KN_reg_fluid(:,[3, 8]), '*')
plot(n_KN_true(:,[3, 8]), n_KN_naive_fluid(:,[3, 8]), 'o')
...
hold on
plot(n_BIZ_true(:,[1,4,5]), n_BIZ_reg_fluid(:,[1,4,5]), '*')
plot(n_BIZ_true(:,[1,4,5]), n_BIZ_naive_fluid(:,[1,4,5]), 'o')
legend('SC, regression', 'SC-INC, regression', 'SC-DEC, regression', 'SC, naive', 'SC-INC, naive', 'SC-DEC, naive', 'Location', 'northwest')
plot([0,8e6], [0, 8e6])
...
hold on
plot(n_BIZ_true(:,[2,6,7]), n_BIZ_reg_fluid(:,[2,6,7]), '*')
plot(n_BIZ_true(:,[2,6,7]), n_BIZ_naive_fluid(:,[2,6,7]), 'o')
legend('MDM, regression', 'MDM-INC, regression', 'MDM-DEC, regression', 'MDM, naive', 'MDM-INC, naive', 'MDM-DEC, naive', 'Location', 'northwest')
...
hold on
plot(n_BIZ_true(:,[3, 8]), n_BIZ_reg_fluid(:,[3, 8]), '*')
plot(n_BIZ_true(:,[3, 8]), n_BIZ_naive_fluid(:,[3, 8]), 'o')
legend('RPI, regression', 'RPI-HET, regression', 'RPI, naive', 'RPI-HET, naive', 'Location', 'northwest')
plot([0,8e6], [0, 8e6])
...
hold on
plot(n_GSP_true(:,[1,4,5]), n_GSP_reg_fluid(:,[1,4,5]), '*')
plot(n_GSP_true(:,[1,4,5]), n_GSP_naive_fluid(:,[1,4,5]), 'o')
legend('SC, regression', 'SC-INC, regression', 'SC-DEC, regression', 'SC, naive', 'SC-INC, naive', 'SC-DEC, naive', 'Location', 'northwest')
plot([0,8e6], [0, 8e6])
...
hold on
plot(n_GSP_true(:,[2,6,7]), n_GSP_reg_fluid(:,[2,6,7]), '*')
plot(n_GSP_true(:,[2,6,7]), n_GSP_naive_fluid(:,[2,6,7]), 'o')
legend('MDM, regression', 'MDM-INC, regression', 'MDM-DEC, regression', 'MDM, naive', 'MDM-INC, naive', 'MDM-DEC, naive', 'Location', 'northwest')
plot([0,15e5], [0, 15e5])
...
hold on
plot(n_GSP_true(:,[3, 8]), n_GSP_reg_fluid(:,[3, 8]), '*')
plot(n_GSP_true(:,[3, 8]), n_GSP_naive_fluid(:,[3, 8]), 'o')
legend('RPI, regression', 'RPI-HET, regression', 'RPI, naive', 'RPI-HET, naive', 'Location', 'northwest')
plot([0,8e6], [0, 8e6])
